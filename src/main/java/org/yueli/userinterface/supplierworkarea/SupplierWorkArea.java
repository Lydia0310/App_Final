...
public class SupplierWorkArea extends javax.swing.JPanel {
    ...
    private void viewOrderJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewOrderJButtonActionPerformed
        ...
        ViewOrder viewOrder = new ViewOrder(userProcessContainer, userAccount, business, network, organization);
    ...
    private void manageDeviceJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageDeviceJButtonActionPerformed
        // TODO add your handling code here:
        ManageDevicePanel manageDevicePanel = new ManageDevicePanel(userProcessContainer, business, userAccount, network, organization);
